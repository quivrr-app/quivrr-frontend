(function () {
  ...
  function createModal() {
    ...
    modal.innerHTML = [
      ...
      '      <button type="button" class="my-quivrr-provider-button full" data-my-quivrr-provider="google" aria-disabled="true"><span class="my-quivrr-provider-label"><span class="my-quivrr-provider-icon my-quivrr-provider-google" aria-hidden="true"><svg viewBox="0 0 24 24" role="presentation" focusable="false"><path fill="currentColor" d="M21.8 12.23c0-.78-.07-1.53-.2-2.25H12v4.26h5.5a4.7 4.7 0 0 1-2.04 3.08v2.56h3.3c1.93-1.78 3.04-4.4 3.04-7.65Z"/><path fill="currentColor" d="M12 22c2.75 0 5.06-.91 6.74-2.47l-3.3-2.56c-.91.61-2.08.97-3.44.97-2.64 0-4.88-1.79-5.68-4.19H2.9v2.64A10 10 0 0 0 12 22Z" opacity="0.88"/><path fill="currentColor" d="M6.32 13.75A6 6 0 0 1 6 12c0-.61.11-1.2.32-1.75V7.61H2.9A10 10 0 0 0 2 12c0 1.61.38 3.13.9 4.39l3.42-2.64Z" opacity="0.72"/><path fill="currentColor" d="M12 6.06c1.5 0 2.84.52 3.9 1.54l2.92-2.92C17.05 3.03 14.74 2 12 2A10 10 0 0 0 2.9 7.61l3.42 2.64c.8-2.4 3.04-4.19 5.68-4.19Z" opacity="0.56"/></svg></span><span>Continue with Google</span></span><span class="my-quivrr-provider-meta" data-my-quivrr-provider-meta="google">Coming soon</span></button>',
      '      <button type="button" class="my-quivrr-provider-button" data-my-quivrr-provider="email" aria-disabled="true"><span class="my-quivrr-provider-label"><span class="my-quivrr-provider-icon my-quivrr-provider-email" aria-hidden="true"><svg viewBox="0 0 24 24" role="presentation" focusable="false"><path fill="currentColor" d="M3 6.75A2.75 2.75 0 0 1 5.75 4h12.5A2.75 2.75 0 0 1 21 6.75v10.5A2.75 2.75 0 0 1 18.25 20H5.75A2.75 2.75 0 0 1 3 17.25V6.75Zm2 .41v.15l7 5.1 7-5.1v-.15a.75.75 0 0 0-.75-.75H5.75a.75.75 0 0 0-.75.75Zm14 2.63-6.41 4.67a1 1 0 0 1-1.18 0L5 9.79v7.46c0 .41.34.75.75.75h12.5c.41 0 .75-.34.75-.75V9.79Z"/></svg></span><span>Continue with Email</span></span><span class="my-quivrr-provider-meta" data-my-quivrr-provider-meta="email">Coming soon</span></button>',
      '      <button type="button" class="my-quivrr-provider-button" data-my-quivrr-provider="microsoft" aria-disabled="true"><span class="my-quivrr-provider-label"><span class="my-quivrr-provider-icon my-quivrr-provider-microsoft" aria-hidden="true"><svg viewBox="0 0 24 24" role="presentation" focusable="false"><path fill="currentColor" d="M3 3h8.5v8.5H3V3Zm9.5 0H21v8.5h-8.5V3ZM3 12.5h8.5V21H3v-8.5Zm9.5 0H21V21h-8.5v-8.5Z"/></svg></span><span>Continue with Microsoft</span></span><span class="my-quivrr-provider-meta" data-my-quivrr-provider-meta="microsoft">Coming soon</span></button>',
      '    </div>',
